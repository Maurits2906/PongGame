...
def accessibility_screen():
    ...
    music_button = Button(WIDTH // 2 - 150, HEIGHT // 2 + 70 , 300, 50, "Toggle Music", "toggle_music")
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            action = keybinds_button.is_clicked(event) or back_button.is_clicked(event) or music_button.is_clicked(event)
